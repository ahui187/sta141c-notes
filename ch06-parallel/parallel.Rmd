...
- BLAS (Basic Linear Algebra Subroutines)
  ...
  - We could also install R with different BLAS libraries such as [openblas](https://github.com/xianyi/OpenBLAS) or [ATLAS](http://math-atlas.sourceforge.net/)
...
We are hoping to use multiple processes to speed up the job. The **conventaional** way is to use the `parallel` package.
