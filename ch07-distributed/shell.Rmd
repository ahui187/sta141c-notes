...
## Create your own server via Google Cloud Computer Engine

- On cavas, there are links to receive $50 education coupon.

- We are going to create a computer engine (virtual machine) on Google cloud platform http://console.cloud.google.com/

- We will need to generate a SSH key pair to login the server

- There are a few way to generate SSH key pair
