...
Inheritance allows object to share behavior. We will use R6 objects to demonstrate. (It is also possible to inheritate S3 objects, but it is not used very often in practice.)
